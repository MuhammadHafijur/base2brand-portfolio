...
const CheckUpMeds = () => {
  return (
    <div className="bg-[#D5F8FD] md:border-l-[22px] border-[#13436B]">
      <div className="w-[92%] flex h-screen mx-auto">
        <div className="flex my-auto flex-col md:flex-row min-w-full justify-items-end items-center ">
          ...
          <div className="w-[66%] mb-8 md:mb-0 mx-auto h-[150px] md:h-auto md:w-1/2 flex justify-center">
            <Image
              src={checkupImg}
              alt="checkupImg"
