...
const CheckUpMeds = () => {
  return (
    <div className="bg-[#D5F8FD] md:border-l-[22px] border-[#13436B]">
      <div className="w-[92%] translate-y-[10%] md:translate-y-0 flex h-screen mx-auto">
        <div className="flex flex-col md:flex-row min-w-full justify-items-end items-center ">
          ...
          <div className="w-[80%] mx-auto mb-8 md:mb-0  md:h-auto md:w-1/2 flex justify-center">
            <Image
              src={checkupImg}
              alt="checkupImg"
